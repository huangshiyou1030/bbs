...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
         ...
         //api 中间件组，应用于routes/api.php 路由文件
        'api' => [
            //使用别名来调用中间件
    ...
    //中间件别名设置，允许你使用别名调用 中间件，例如上面 的api 中间件组调用
    protected $routeMiddleware = [
        ...
        //只有游客才能访问，在register 和 login 请求中使用，只有未登陆用户才能访问这些页面
        'guest' => \App\Http\Middleware\RedirectIfAuthenticated::class,
        //访问节流，类似于 1分钟只能请求10次的需求，一般在api 中使用
